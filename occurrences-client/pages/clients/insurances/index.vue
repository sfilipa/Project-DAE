    ...
    <div v-for="insurance in insurances" class="insurance-box">
      <div class="details-left">
        ...
        <nuxt-link
          ...
          :to="`/clients/insurances/${insurance.name}`">Check Insurance Details
        </nuxt-link>
      </div>
      <div class="flex-grow-1 details-right">
        <nuxt-link
          class="btn btn-register-occurrence-right pb-3 pr-5"
          :to="{name: `clients-insurances-name`, params: {name:insurance.name, OccurrencesBtn: true}}">
        ...
        <nuxt-link
          ...
          :to="{name: `clients-insurances-name`, params: {name:insurance.name, DocumentsBtn: true}}">
